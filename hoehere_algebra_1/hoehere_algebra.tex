...
\subsection[Satz: Zerlegung eines endlich erzeugten Moduls in ein Torsionsmodul und einen freien Modul]{Satz} % (fold)
\label{sub:251}
...
\subsection[Satz: Tensorprodukt mit freiem Modul]{Satz} % (fold)
\label{sub:35}
...
\minisec{Beweis}
$A \simeq \im \rho \subseteq M_n(K) \simeq \End_K(A)$. \bewende
% subsection 312 (end)
...
\minisec{Beweis}
Es genügt nachzurechnen, dass diese Multiplikation bilinear ist und die Eigenschaften  von $A,B$ sich übertragen.
% subsection 313 (end)
