...
Form $M_n(D)e_{ii}$ mit $K$-Dimension $n \cdot \dim_K D$. Ist $\rho_i$ die zu $J_i = A_i$ gehörige irreduzible Darstellung, dann ist für eine beliebige Darstellung 
...
\[
	p \sim m_1 \rho_1 \oplus \ldots \oplus m_s \rho_s
\]
% subsection 411 (end)

\subsection{Satz} % (fold)
\label{sub:412}
Ist $\rho : G \to K[G]$ die reguläre Darstellung, dann ist die Vielfachheit von $\rho_i$ in $\rho$ genau $n_i$ in der Notation von vorher.
% subsection 412 (end)
% section 4 (end)
