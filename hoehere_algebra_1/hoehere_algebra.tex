...
\label{sub:315}
Eine $K$-Algebra heißt \bet{zentral}\index{Algebra!zentral}, wenn $C(A)= K \cdot 1_A$. Ist $A$ eine endlich dimensionale einfache $K$-Algebra, dann ist nach Wedderburn (\ref{sub:229}) $A \simeq M_n(D)$ für einen Schiefkörper $D$, der endliche Dimension über $K$ hat. Weiter ist 
\[
...
\subsection{Korollar} % (fold)
\label{sub:325}
Sind $A_1, \ldots , A_n$ endlich dimensionale zentral einfache $K$-Algebren, dann ist auch $A_i \otimes \ldots \otimes A_n$ zentral einfach und endlich dimensional.
% subsection 325 (end)
...
ein Zerfällungskörper für $A$, falls $A_E = A \otimes_K E \simeq M_n(E)$ für ein $n \in \mathds{N}$. Man sagt $A$ zerfällt über $E$. 
% subsection 326 (end)
