...
\subsection[Satz: $R$-Moduln über einen Schiefkörper $R$]{Satz} % (fold)
\label{sub:238}
...
\subsection[Lemma: Definition von IBL mit Matrizen]{Lemma} % (fold)
\label{sub:240}
...
\subsection[Satz: IBL gilt für kommutative und noethersche Ringe und Urbilder]{Satz} % (fold)
\label{sub:241}
Sei $R \not= 0$ ein Ring.
\begin{enumerate}[(i)]
...
\subsection[Definition: $i$-Minoren]{Definition} % (fold)
\label{sub:244}
...
\subsection[Beispiele zur Zerlegung]{Beispiel} % (fold)
\label{sub:252}
\begin{enumerate}[(i)]
...
\subsection[Bemerkung: Tensorprodukte der Elemente]{Bemerkung} % (fold)
\label{sub:32}
...
\subsection[Satz: Tensorprodukt von $R$-Modul mit $R^n$]{Satz} % (fold)
\label{sub:35}
...
\subsection[Korollar: Tensorprodukt mit freiem Modul]{Korollar} % (fold)
\label{sub:37}
...
\subsection[Korollar: $n$-dimensionale $K$-Algebren]{Korollar} % (fold)
\label{sub:312}
