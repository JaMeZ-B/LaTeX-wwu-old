...
\label{sub:26}
\begin{enumerate}[(i)]
	\item Ist $M$ ein zyklischer $R$-Modul, dann ist $M \simeq \nicefrac{R}{I}$ für ein Ideal $I \unlhd R$. \hfill(siehe Blatt 3)\todo{Beweis texen und in Anhang}
...
\subsection[Bemerkung: Elemente des Tensorprodukts, Modulstruktur des Tensorprodukts]{Bemerkung} % (fold)
\label{sub:32}
...
\label{sub:427}
Sei $G$ eine endliche Gruppe, $K$ der Zerfällungskörper für $G$, $\Char K = 0$\marginnote{$K= \mathds{C}$}. Sind $\rho, \sigma$ irreduzible Darstellungen der Dimension $c$
