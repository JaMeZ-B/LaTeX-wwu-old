...
\begin{beweis}
	...
	Nach \autoref{prop:H0_kettenhomotop} ist $\Sp$ damit kettenhomotop zur Identität.
\end{beweis}
...
\begin{proposition}[label=prop:H0_kettenhomotop]
	...
	$\tau_*$ kettenhomotop zur Identität, das heißt es gibt eine natürliche Transformation $\eta_* \colon C_*^\sing \to C_{*+1}^\sing$ mit \todo{Revision 4}
	\[
		d^\sing_{*+1} \circ \eta_* + \eta_{*+1} \circ d_*^\sing = \id -\tau_* 
	\]
\end{proposition}
\begin{beweis}
