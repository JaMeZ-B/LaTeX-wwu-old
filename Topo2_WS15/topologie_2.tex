...
\begin{beweis}
	...
	\[
		\begin{tikzcd}[sep=small]
			\mu^{\mathbb{R}^n}_{h(x)} \in H_n \enbrace*{\mathbb{R}^n,\mathbb{R}^n \setminus \set*{h(x)}} & H_n(V,V\setminus \set*{h(x)}) \lar["\cong"'] &
			H_n(U,U \setminus \set*{x}) \lar["\cong","h_*"'] \rar["\cong"] & H_n(M,M \setminus \set*{x})
		\end{tikzcd}
	\]
