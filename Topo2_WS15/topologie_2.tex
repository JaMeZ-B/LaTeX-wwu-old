...
\begin{beweis} Wir betrachten folgendes Diagramm
	...
	Dann ist $i \circ s$ homotop zu $\id_{D^1 \times X}$, also $s^* \circ i^*=\id$ in Kohomologie und mit der Exaktheit folgt $j^*=0$. $s^*$ ist die gesuchte Spaltung.\todo{Revision 3}
