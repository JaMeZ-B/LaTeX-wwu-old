...
\begin{beweis}
	...
	Es gilt für den ersten Summanden der rechten Seite\todo{Rechnung durchgucken}
	\begin{align}
		d^p(\alpha) \cupp \beta(\sigma) &= (-1)^{q(p+1)}\cdot  (d^p \alpha) \enbrace*{\sigma|_{\benbrace*{0,\ldots ,p+1}}} \beta \enbrace*{\sigma|_{\benbrace*{p+1,\ldots ,p+q+1}}} \\
