...
\begin{bemerkung}
	...
	\[
		\colim_\Lambda \ker \tau = \ker \colim_\Lambda \tau \qquad \colim_\Lambda \coker \tau = \coker \colim_\Lambda \tau
	\]
\end{bemerkung}
...
\end{korollar}
\begin{beweis}
	Sei $d^{C_1}_n \colon C_n(\lambda) \to C_{n-1}(\lambda)$ die Randabbildung. 
