...
\begin{satz}
	...
	Sei $M$ weiter homotopieäquivalent zu einen endlichen CW-Komplex.\footnote{Dies ist im Allgemeinen \emph{nicht} Fall, wie Aufgabe 4 von Blatt 5 zeigt} 
	Dann ist $\chi_M =0$.
\end{satz}
\begin{beweis}
...
\begin{bemerkung}
	Am Beweis der Poincaré-Dualtität hindern uns momentan noch folgende Probleme, die wir in diesem Kapitel \enquote{umschiffen} wollen\todo{Revision 7}
	\begin{itemize}
