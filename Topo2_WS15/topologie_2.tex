...
Frage: Sei $\mathcal{U}$ eine offene Überdeckung von $X$. Dann haben wir schon gesehen, dass die Inklusion $i \colon C_*^\mathcal{U}(X;R) \to C_*^\sing(X;R)$ einen Isomorphismus in 
