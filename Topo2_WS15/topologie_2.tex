...
\begin{definition}[{name=[graduierte Algebra]}]
	\todo{Revision 4}
	Eine \Index{graduierte Algebra} ist ein graduierter Modul $A^* = \bigoplus_p A^p$ zusammen mit einer $R$-Algebrastruktur, für die das Produkt mit der Graduierung verträglich 
	ist: Für $a \in A^p$ und $b \in A^q$ ist $a \cdot b \in A^{p+q}$. Sie heißt \Index{graduiert-kommutativ}, falls gilt 
	\[
		a \cdot b =  (-1)^{p \cdot q} \cdot b \cdot a
	\]
	für alle $a \in A^p$ und $b \in A^q$.
\end{definition}

\begin{bemerkung}
	Das $\cup$-Produkt auf $C^*_\sing(X;R)$ ist \emph{nicht} graduiert kommutativ. (siehe \ref{sec3:def_cup})
\end{bemerkung}
