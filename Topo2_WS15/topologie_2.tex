...
\begin{proposition}[label=prop:H0_kettenhomotop,{name=[Nullkettenhomotopie von natürlichen Transformationen $C_*^\sing \to C_*^\sing$]}]
...
\begin{korollar}[label=korr:H0_kettenhomotop,{name=[Kettenhomotopie von natürlichen Transformationen $C_*^\sing \to C_*^\sing$]}]
