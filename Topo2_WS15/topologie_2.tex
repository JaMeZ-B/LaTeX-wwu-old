...
\begin{proposition}
	Sei $R$ ein Ring, $C_*$ ein Kettenkomplex von $R$-Rechtsmoduln und $D_*$ ein Kettenkomplex von $R$-Linksmoduln.\todo{Revision 16}
	\begin{enumerate}[a)]
...
\begin{satz}{name={Eilenberg-Zilber}}
	Sei $R$ ein kommutativer Ring, $X,Y$ topologische Räume.
	Dann induziert 
	\[
		\enbrace*{\sigma \colon \abs*{\Delta^n} \to X \times Y } \longmapsto \sum_{p=0}^{n} (\pr_X \circ \sigma)\big|_{\benbrace*{0,\ldots ,p}} \otimes (\pr_Y \circ \sigma)\big|_{p,\ldots ,n}
	\]
...
\begin{proposition}
	...
	\(
		m \colon C_*(X;R) \otimes_R C_*(Y;R) \longrightarrow C_*(X \times Y;R)
	\)
	mit 
	\[
		m \enbrace*{ \enbrace*{\sigma \colon \abs*{\Delta^0} \to X } \otimes \enbrace*{\tau \colon \abs*{\Delta^0} \to Y}}= \enbrace*{\sigma \times \tau \colon \abs*{\Delta^0} \to X \times Y}
	\]
\end{proposition}
\begin{beweis}
	Wir benutzen die \emph{Methode der azyklischen Modelle} und konstruieren 
	\[
		m_n \colon \bigoplus_{p+q=n} C_p(X;R) \otimes_R C_q(Y;R) \longrightarrow C_n(X \times Y;R) 
	\]
	...
	Für $p+q=n$ betrachte $\id_{\abs*{\Delta^p}} \otimes \id_{\abs*{\Delta^q}} \in Cp(\abs*{\Delta^p};R) \otimes_R C_q \enbrace*{\abs*{\Delta^q};R}$.
	Dann liegt $m_{n-1} \enbrace*{\partial \enbrace*{\id_{\abs*{\Delta^p}} \otimes \id_{\abs*{\Delta^q}}}}$ im Kern von $\partial$ auf $C_{n-1} \enbrace*{\abs*{\Delta^p} \times \abs*{\Delta^q};R}$.
	Wegen $H_*(\abs*{\Delta^p} \times \abs*{\Delta^q})=0$ gibt es $v_{p,q} \in C_n \enbrace*{\abs*{\Delta^p} \times \abs*{\Delta^q}}$ mit 
	\[
