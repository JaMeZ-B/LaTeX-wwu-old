...
\begin{beweis}
	...
	Nach \autoref{angabe_iso_s1} liefert $(\eta_1,\eta_2) \mapsto \enbrace[\big]{\pi_{T^n}^*(\eta_1) + \xi\times \eta_2}$ einen Isomorphismus $H^p(T^n;R) \oplus H^{p-1}(T^n;R) \cong H^{p}(T^{n+1};R)$.\todo{fertig machen}
