...
\begin{beweis} Wir betrachten folgendes Diagramm
	...
	Genauso überlegt man sich, dass die Paarfolge\todo{Warum da gleich die Nullabbildung steht, ist mir noch nicht klar}
	\[
		\begin{tikzcd}
...
\begin{bemerkung}
	...
	Dies stellt einen Zusammehang zwischen $H_*(V \otimes C_*)$ und $\Tor_*^R \enbrace*{V, H_*(C_*)}$ her.
\end{bemerkung}
