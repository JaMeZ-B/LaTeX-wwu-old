...
\newcommand{\so}{\mathrm{s\mkern-1.4mu.\mkern-.6mu o\mkern-1.7mu.}} % \newcommand{\so}{\mathrm{s.o.}}
\newcommand{\solim}{\so\text{-}\lim}
\newcommand{\wo}{\mathrm{w\mkern-1.7mu.\mkern-.45mu o\mkern-1.7mu.}}
...
\newcommand{\MyTo}[1]{\tikzexternaldisable\mathbin{\tikz[baseline] \draw[-to,line width=.4pt] (0ex,0.83ex) -- (#1,0.83ex);}\tikzexternalenable}
\newcommand{\dlim}{%
    \mathchoice
      {\lim\limits_{\MyTo{3.3ex}}}% \displaystyle
