...
\begin{minipage}[t]{0.45\textwidth}
	\centering{\includegraphics[width=3cm, keepaspectratio]{../!config/Bilder/qr_github.pdf} \medskip\\
...
\begin{minipage}[t]{0.45\textwidth}
	\centering{
	\includegraphics[width=3cm, keepaspectratio]{../!config/Bilder/qr_btsync.pdf} \medskip\\
