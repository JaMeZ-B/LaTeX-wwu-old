...
\begin{itemize}
	\item Persönliches Ansprechen in der Uni, Mails an \hrefsym{mailto:j.bantje@wwu.de}{j.bantje@wwu.de} (gerne auch mit annotieren PDFs) 
...
{\centering \small \url{\homepage}\par}