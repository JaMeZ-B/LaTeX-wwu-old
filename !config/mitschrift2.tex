...
\ifxetexorluatex
	...
	% \newcommand\glqq{"}
	% \newcommand\grqq{"}
	\defaultfontfeatures{Mapping=tex-text, WordSpace={1.2}, Ligatures=Common} %
	...
	% \setsansfont{SourceSansPro}[Scale=MatchLowercase,Extension=.otf,UprightFont=*-Regular,BoldFont=*-Semibold,ItalicFont=*-LightIt,BoldItalicFont=*-SemiboldIt]
...
\ifxetexorluatex\setlist[itemize,1]{label=\faCaretRight}\fi
