...
\newcommand{\ceil}[1]{\left\lceil #1 \right\rceil}		% aufrunden
\newcommand{\floor}[1]{\left\lfloor #1 \right\rfloor}	% aufrunden
\newcommand{\sprod}[1]{\left\langle #1 \right\rangle}	% spitze Klammern
\newcommand{\enbrace}[1]{\left( #1 \right)}				% runde Klammern
\newcommand{\benbrace}[1]{\left\lbrack #1 \right\rbrack}			% eckige Klammern
\newcommand{\penbrace}[1]{\left\{ #1 \right\}}			% geschweifte Klammern
