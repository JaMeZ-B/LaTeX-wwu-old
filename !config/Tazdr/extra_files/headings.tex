...
\titlehead{\includegraphics[width=6cm, keepaspectratio]{../!config/Tazdr/Bilder/Logo_WWU_Muenster_light_gray.jpg}
			\hfill
			\includegraphics[width=7cm, keepaspectratio]{../!config/Tazdr/Bilder/fb10logo.jpg}}
\title{\vorlesung}
\subtitle{\subt}
