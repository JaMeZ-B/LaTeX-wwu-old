...
\ohead{\footnotesize \sffamily \color{light_gray} \includegraphics[height=0.5 cm, keepaspectratio]{../!config/Tazdr/Bilder/Logo_WWU_Muenster_light_gray.jpg}
	\includegraphics[height=0.4cm, keepaspectratio]{../!config/Tazdr/Bilder/fb10logo.jpg}
...
\titlehead{\includegraphics[width=7cm, keepaspectratio]{../!config/Tazdr/Bilder/Logo_WWU_Muenster_light_gray.jpg}
			\hfill
			\includegraphics[width=6cm, keepaspectratio]{../!config/Tazdr/Bilder/fb10logo.jpg}}
\title{\vorlesung}
\subtitle{\subt}
\publishers{gelesen von \\ \Prof}