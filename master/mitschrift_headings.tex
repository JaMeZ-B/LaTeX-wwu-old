...
\titlehead{\includegraphics[height=1.5cm, keepaspectratio]{../master/Bilder/Logo_WWU_Muenster.pdf}%
\hfill \includegraphics[height=1.3cm, keepaspectratio]{../master/Bilder/fb10logo.pdf}}
\title{Skript \fach}
...
\begin{minipage}[t]{0.45\textwidth}
	\centering{\includegraphics[width=3.2cm, keepaspectratio]{../master/Bilder/qr_github.pdf} \medskip\\
...
\begin{minipage}[t]{0.45\textwidth}
	\centering{
	\includegraphics[width=3.2cm, keepaspectratio]{../master/Bilder/qr_btsync.pdf} \medskip\\
