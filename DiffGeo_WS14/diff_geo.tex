...
\[
f\circ \varphi^{-1}: V\cap (\mathds{R}^n\times \set{0}) \overset{\varphi^{-1} \vert_{V\cap (\mathds{R}^n\times \set{0})}\in C^{\infty}(\mathds{R}^n,\mathds{R}^{n+k})}{\to} M\cap U \overset{f \in C^{\infty}(\mathds{R}^{n+k},\mathds{R}^m)}{\to} \mathds{R}^m
\]
...
\[
u \sim v \overset{\text{Def.}}{\Leftrightarrow} v = \mathd_{\varphi(x)}(\psi \circ \varphi^{-1})(u)
\]
...
\subsubsection{Definition}
\label{ssub:155}
$TM := \bigcap_{x\in M} T_x M$ ist das \Index{Tangentialbündel} von $M$.
