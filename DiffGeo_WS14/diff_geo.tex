...
\]
mit $\hat{\alpha}_j \in \Gamma(T^* M), \hat{v}_j \in \Gamma(TM)$ glatte Fortsetzung nach \ref{ssub:11010}
\begin{enumerate}[(a)]
...
% subsubsection 11011(end)

\subsubsection{Definition}
\label{ssub:11012}
Sei $f:M\to N$ glatte Abbildung, $S\in \Gamma(\mathcal{T}_q M)$. Der \Index{Pullback} von $S$ unter $f$ ist der Tensor $S^* \in \Gamma(\mathcal{T}_q M)$ definiert durch
\[
