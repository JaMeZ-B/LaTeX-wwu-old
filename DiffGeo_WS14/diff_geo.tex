...
Diffeomorphismus $f : U \subseteq \mathds{R}^n \to \mathds{R}^n$ glatt, bijektiv und $f ^{-1}$ glatt.
...
\label{ssub:111}
Eine Abbildung $f : U \subseteq \mathds{R}^n \to \mathds{R}^m$ glatt heißt \Index{Submersion}/\Index{Immersion}/\Index{Etale} in $x \in U$, falls
...
\bet{Submersion}/\bet{Immersion}/\bet{Etale}, falls $f$ Submersion/Immersion/Etale für alle $x \in U$ ist.
% subsubsection 111 (end)

\subsubsection{Bemerkung} % (fold)
\label{ssub:112}
Submersiv/immersiv/étale sind offene Bedingungen, d.h. ist $f$ Submersion/Immersion/Etale in $x$, so auch in einer hinreichend kleinen Umgebung von $x$ (vergleiche auch Satz 
15 unten)
