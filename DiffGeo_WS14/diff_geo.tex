...
Sei zum Beispiel $M = S^2$. So ist $f(x,y,z)=x^2+y^2+z^2-1$ eine Submersion mit $S^2 = f^{-1}(0)$. Betrachte nun den Tangentialraum am Nordpol $N$. Es gilt $\mathd_N f = (0,0,z): \mathds{R}^3 \to \mathds{R}$\todo{müsste das nicht $(0,0,2z)$ sein?}, also gilt für den Tangentialraum: 
\[
