...
\label{sub:113}
Ein \bet{$\mathbf{CW}$-Komplex}\index{CW-Komplex@\CW-Komplex}\footnote{Zitat von \hrefsym{https://en.wikipedia.org/wiki/CW_complex}{Wikipedia} zum Namen: \textenglish{\emph{The C stands for "closure-finite", and the W for "weak topology".}}} ist ein topologischer Raum $X$ zusammen mit einer Filtrierung\footnote{siehe auch \url{https://de.wikipedia.org/wiki/Filter_(Mathematik)}} durch Unterräume von $X$: 
\[
