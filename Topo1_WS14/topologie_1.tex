...
\[
	{\begin{tikzcd}[row sep=large, column sep=tiny, arrows=thick]
		...
		0=H_n \enbrace*{X^{\ssbrace{n-1}}} \arrow[dr,Firebrick3] & & H_n \enbrace*{X^{\ssbrace{n+1}}} \rar["\cong", "\text{Lemma b)}"']  \arrow[ur, Goldenrod2] & H_n(X)\\  
		& H_n \enbrace*{X^{\ssbrace{n}}} \arrow[ur, two heads, Goldenrod2] \arrow[dr, hook, "j^{(n)}_*", Firebrick3]\\
		H_{n+1} \enbrace*{X^{\ssbrace{n+1}},X^{\ssbrace{n}}} \arrow[ur, Goldenrod2]\arrow[rr,"\partial_{n+1}^{\cell}"] 
		...
		& & & H_{n-1} \enbrace*{X^{\ssbrace{n-1}}} \arrow[ur, hook, DodgerBlue3] \\
		& & \underset{=0}{H_{n-1}\enbrace*{X^{\ssbrace{n-2}}} } \arrow[ur, DodgerBlue3]
	\end{tikzcd}}
\]
Es folgt, dass $j_*^{(n)}$ ein Isomorphismus ist, $H_n(X^{\ssbrace{n}};R) \xrightarrow{\cong} \ker \partial_n^{\cell}$ und $\im \partial_{n+1}^{X^{\ssbrace{n+1}}, X^{\ssbrace{n}}} \xrightarrow{\cong} \im \partial_{n+1}^{\cell}$. Weiter erhalten wir einen Isomorphismus
\[
	\begin{tikzcd}
		H_n(X;R) \cong H_n \enbrace*{X^{\ssbrace{n+1}};R} & \nicefrac{H_n(X^{\ssbrace{n}};R)}{ \im \partial_{n+1}^{X^{\ssbrace{n+1}}, X^{\ssbrace{n}}}} \lar["\cong"] 
	\end{tikzcd}
\]
...
\begin{enumerate}[a)]
	...
	Damit folgt \begin{enumerate}[(1)]
		...
		\item $\forall x\in H_k(X^{\ssbrace{n}};R)$ mit trivialem Bild von $x$ in $H_k(X;R)$, gibt es ein $m \ge n$, sodass das Bild von $x$ in $H_k(X^{(m)};R)$
		trivial ist.
	\end{enumerate}
	Da für $m \ge n >k$ die Abbildung $H_k(X^{\ssbrace{n}};R) \to H_k(X^{(m)};R)$ ein Isomorphismus ist, ergibt sich damit die Behauptung. \bewende
\end{enumerate}
% subsection 129 (end)
