...
$\mu_U \in H_n(\mathds{R}^n,\mathds{R}^n \setminus \set{0};R)$ ein Erzeuger, so ist also $\mu_y = \mu_U|_y$ eine Orientierung von $\mathds{R}^n$ in $y$ für alle $y \in U$.\todo{RevChap16}
% subsection 166 (end)
