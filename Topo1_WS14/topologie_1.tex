...
\]
heißt die \bet{Eulercharakteristik}\index{Eulercharakteristik!von $\mathds{Z}$-Kettenkomplexen} von $C_*$. Dabei ist $n_0$ so gewählt, dass $C_n =0$ für alle $n >n_0$. 
% subsection 49 (end)
