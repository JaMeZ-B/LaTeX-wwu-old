...
\begin{enumerate}[1)]
	...
	\end{tikzcd}$
	eine kurze exakte Folge mit $M_2$ frei, also $M_2 \cong R[S]$, so spaltet \eqref{eq:43}.
...
\begin{enumerate}[1)]
	...
	\item Ist $X$ wegzusammenhängend, so gilt $H_0(X) \cong \mathds{Z}$.\marginnote{Tatsächlich gilt auch die Umkehrung, wie in Aufgabe 4 von Blatt 3 gezeigt.}
\end{enumerate}
\minisec{Beweis}
\begin{enumerate}[1)]
