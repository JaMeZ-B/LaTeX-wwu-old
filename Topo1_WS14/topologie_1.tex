...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[scale=1.5, thick]
		...
		\draw (5.5,-0.5) coordinate (m) -- ++(3,0) coordinate (n) -- ($(m)!.5!(n) + (0,0.75)$) coordinate (o) -- cycle;
...
\label{sub:1310}
Für jeden topologischen Raum $X$ ist $(B_*)_X$ eine Kettenabbildung und $(H_*)_X$ eine Kettenhomotopie zwischen $(B_*)_X$ und der Identität.\todo{Beweis {\TeX}en} 
\todo{RevChap13}
% subsection 1310 (end)
