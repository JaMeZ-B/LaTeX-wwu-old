...
\begin{itemize}
	...
	\enquote{$\Delta^n \setminus \set{0,\ldots ,n}$}. $\partial \Delta^n$ heißt der \Index{Rand des $n$-Simplizes}. Es gilt \todo{RevChap2}
	\begin{align*}
	...
	\end{tikzpicture}}} \cong S^1 \\
		\abs*{\partial \Delta^3} &= \vcenter{\hbox{\begin{tikzpicture}
			\coordinate (0) at (0,0);
			\coordinate (1) at (1,0);
			\coordinate (2) at (0.5,0,0.866);
			\coordinate (3) at (0.5,0.866,0.433);
			\draw[sharp corners] (0) -- (1) -- (2) -- (0) -- (3) -- (2) -- (1) -- (3) -- cycle;
		\end{tikzpicture}}} \cong S^2 
	\end{align*}
	Allgemein gilt $\abs*{\partial \Delta^n} \cong S^{n-1}$.
	\item $T^2 = S^1 \times S^1 \cong \text{ Bild Torus} \cong \text{ Zeichnung aus Skript}$ \todo{Zeichnungen hinzufügen}
\end{itemize}
% subsection 27 (end)
