...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[scale=0.9]
		...
		\draw[ultra thick, Firebrick3] (0,-0.5) rectangle (2,1) node[midway]{$L$};
...
\]
Dann induziert die Inklusion $C_*^\mathcal{U}(X,A;R) \hookrightarrow C_*(X,A;R)$ einen Isomorphismus in Homologie. Der Beweis benutzt die Paarfolge und das 5er-Lemma.
\todo{RevChap13}
% subsection 134 (end)
...
dem Satz über kleine Simplizes induzieren die beiden vertikalen Inklusionen Isomorphismen in Homologie:
\[
