...
\bet{$\mathbf{n}$-te Kettenmodul}\index{nterKettenmodul@$n$-ter Kettenmodul} von $K$ über $R$ ist definiert als 
\[
	C_n(K;R) := R[\Sigma_n]
\]
...
\label{sub:36}
Sei $K=(V,\Sigma)$ ein geordneter simplizialer Komplex. Die \bet{$\mathbf{n}$-te Randabbildung}\index{nte Randabbildung@$n$-te Randabbildung} 
\[
...
\label{sub:310}
Sei $K$ ein geordneter simplizialer Komplex. Der \bet{$\mathbf{n}$-te Homologiemodul}\index{nter Homologiemodul@$n$-ter Homologiemodul} von $K$ über $R$ ist 
definiert als
\[
...
\label{sub:314}
Zu einem geordneten simplizialen Komplex $K$ heißt $\enbrace[\big]{C_*(K;R), \partial_*}$ der \Index{simpliziale Kettenkomplex} von $K$ über $R$. 
\minisec{Bemerkung}
...
\]
heißt die \bet{Eulercharakteristik}\index{Eulercharakteristik!von $\mathds{Z}$-Kettenkomplexen} von $(C_*,d_*)$. Dabei ist $n_0$ so gewählt, dass $C_n =0$ für alle 
$n >n_0$. 
% subsection 49 (end)
...
Sei $R$ ein Ring. Der \bet{$\mathbf{n}$-te (singuläre) Kettenmodul}\index{n-ter (singulärer) Kettemodul@$n$-ter (singulärer) Kettenmodul} von $X$ über $R$ ist
\todo{Rev Chap 5}
\[
...
\label{sub:54}
Die \bet{$\mathbf{n}$-te singuläre Randabbildung}\index{n-te singuläre Randabbildung@$n$-te singuläre Randabbildung} $\partial_n : C_n(X;R) \to C_{n-1}(X;R)$ ist 
definiert durch 
\[
...
\missingfigure{Hier komme noch ein paar Simplizes hin mit Zerlegung und so }
% subsection 79 (end)
