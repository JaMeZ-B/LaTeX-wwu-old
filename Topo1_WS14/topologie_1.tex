...
ist definiert durch
\[
	\partial_n(\sigma) = \sum_{\tau \in \Sigma_{n-1}} \varepsilon_\sigma^\tau \cdot \tau \qquad \text{ für } \sigma \in \Sigma_n
\]
% subsection 36 (end)
...
\begin{align*}
	\partial_{n-1} \enbrace[\big]{\partial_n (\sigma)} = \partial_{n-1} \enbrace*{ \sum_{\tau \in \Sigma_{n-1}} \varepsilon_\sigma^\tau \cdot \tau} = \sum_{\tau \in \Sigma_{n-1}} \varepsilon_{\sigma}^\tau \cdot \partial_{n-1} (\tau) 
...
\begin{enumerate}[(1)]
	...
	\item Sein nun $K$ das $(n+1)$-Eck (Nummerierung der Vertices $0,\ldots ,n$), wobei $n \ge 3$. Dann gilt
	\begin{align*}
		C_0(K;R) &= R[\Sigma_0] \cong R^{n+1} \\
		C_1(K;R) &= R[\Sigma_1] \cong R^{n+1} \\
