...
$\sigma = \set{0, \ldots , n}$ schreiben wir $\Delta^n := \Delta^{\set{0, \ldots ,n}}$.
\[
	...
	\vcenter{\hbox{\begin{tikzpicture}
			...
			\coordinate (3) at (0.5,0.433,0.866);
			\foreach \x in {0,1,2,3}{
				\foreach \y in {0,1,2,3}{
					\foreach \z/\col in {0/DodgerBlue2,1/Coral2,2/Green2,3/Gold1}{
					\draw[thick, fill=\col!40, fill opacity=0.2] (\x) -- (\y) -- (\z) -- cycle;
					};
				};
			};
			\foreach \x in {0,1,2,3} {
