...
\label{sub:78}
Die Homotopieinvarianz von $H_n(-;R)$ folgt aus:
\begin{equation*}
	\text{Seien $i_0,i_1  :X \hookrightarrow X \times [0,1]$ Inklusionen mit $i_0(x)= (x,0)$, $i_1(x)=(x,1)$. \\ Dann gilt $(i_0)_* = (i_1)_*$} \label{eq:78} \tag{\#}
\end{equation*}
\minisec{Beweis}
Sei $H : X \times [0,1] \to Y$ eine Homotopie zwischen $f,g : X \to Y$, also $f = H \circ i_0$ und $g = H \circ i_1$. Dann folgt \eqref{eq:78}
\begin{align*}
