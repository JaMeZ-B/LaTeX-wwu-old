...
\label{sub:102}
Jede stetige Abbildung $f \colon D^n \to D^n$ besitzt einen Fixpunkt. \todo{RevChap10}
\minisec{Beweis}
...
mit $F|_{S^{n-1}} = \id_{S^{n-1}}$. In Homologie erhalten wir folgendes kommutatives Diagramm \marginnote{\oE: $n\ge 2$}
\[
...
\subsection[Beispiel: Abbildungsgrad der Spiegelung]{Beispiel} % (fold)
\label{sub:105}
