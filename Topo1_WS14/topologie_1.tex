...
\label{sub:141}
Mit $V \colon \TOP^2 \to \TOP^2$ bezeichnen wir den Funktor $V(X,A) = (A,\emptyset)=A$. \todo{RevChap14}
% subsection 141 (end)
...
\begin{enumerate}[(i)]
	\item \Index{Paarfolge}: Sei $(X,A)$ ein Paar von topologischen Räumen. Seien $X= (X,\emptyset) \xrightarrow{j} (X,A)$ und 
