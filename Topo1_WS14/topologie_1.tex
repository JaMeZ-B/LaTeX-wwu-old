...
$f(A) \subseteq A'$ und $f(B) \subseteq B'$, so kommutiert\index{natürliche Transformation}
\[
...
\label{sub:95}
Sei $X$ ein nichtleerer topologischer Raum. Sei $p \colon X  \to \set{\mathrm{pt}}$ die Projektion auf den Ein-Punkt-Raum. die \Index{reduzierte singuläre Homologie} von $X$ ist definiert
durch 
\[
