...
$H_*(B,A \cap B;R) \to H_*(X,A;R)$ induziert. \todo{RevChap9}
% subsection 93 (end)
...
$k := h\big|_{\mathds{R}^n\setminus \set{x_0}} \colon \mathds{R}^n \setminus \set{x_0} \to \mathds{R}^m  \setminus \set{h(x_0)}$. Nun ist $\mathds{R}^n \setminus \set{x_0}$
