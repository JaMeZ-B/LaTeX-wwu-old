...
\end{align*}
Dann folgt $\partial \sigma = \delta_0 \sigma - \delta_1 \sigma + \delta_2 \sigma = \omega - \omega * \omega' + \omega'$. \bewende \todo{RevChap15}
\begin{figure}[t]
	\centering{
...
\missingfigure{Quadrat nach $X$, linke Seite kollabieren, Simplex nach $X$}
