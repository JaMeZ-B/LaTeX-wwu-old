...
Zur Vorbereitung müssen wir kurz wiederholen, was eine Abelisierung ist: \todo{RevChap15}
...
\label{sub:153}
Der Quotient $G^\ab := \nicefrac{G}{[G,G]}$ heißt \Index{Abelisierung} (manchmal auch Abelianisierung) von G.\marginnote{Für eine abelsche Gruppe $G$ ist sinnigerweise
$G^\ab=G$.} 
% subsection 153 (end)
...
\missingfigure{Simplex kollabieren und so weiter} 
% subsection 156 (end)
