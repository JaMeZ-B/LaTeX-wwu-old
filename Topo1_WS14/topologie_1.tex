...
$h_n : C_n(X;R) \to C_{n+1}(X \times [0,1];R)$ mit $\partial_{n+1} \circ h_n + h_{n-1} \circ \partial_n = C_n(i_0;R)- C_n(i_1;R)$.
...
\subsection[Beweis von {[\#]}]{Beweis von \protect\eqref{eq:78}} % (fold)
\label{sub:713}
