...
Um daraus Sinn zu machen, zerlegen wir $\abs*{\Delta^n} \times [0,1]$ in eine Vereinigung von $(n+1)$-Simplizes. $\Delta^n \times [0,1]$ hat die folgende Form für
$n \in \set{0,1,2}$:
\begin{figure}[H]
	\centering{
	\scalebox{0.9}{\begin{tikzpicture}[scale=2.0]
		\coordinate (1) at (0,1);
		\coordinate (2) at (0,0);
		...
		\draw[thick] (7) node[left]{$(0,0)$} node[above, yshift=0.4cm, xshift=0.9cm]{$\Delta^2$} -- (8) node[right]{$(2,0)$} -- (9) node[right]{$(1,0)$} -- cycle;
