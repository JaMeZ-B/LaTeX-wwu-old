...
\label{sub:1518}
$0$-zusammenhängend entspricht wegzusammenhängend und $1$-zusammenhängend entspricht wegsammenhängend und einfach zusammenhängend. \todo{RevChap15}
% subsection 1518 (end)
...
von $I^n$, für die $s_n=0$ gilt. Außerdem setzen wir $\overline{J^{n-1}=\partial I^n \setminus I^{n-1}}$. Die \Index{relative Homotopiegruppe} $\pi_n(X,A,x_0)$ besteht aus 
...
\missingfigure{Bild zu relativen Homotopiegruppen}
