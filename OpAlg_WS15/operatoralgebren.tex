...
\begin{beweis}
	...
	Wegen der oben gezeigten Surjektivität und der Tatsache, dass alle Charaktere in $\Omega\enbrace[\big]{C_0(\Omega(A))}$ Auswertungsabbildungen sind, folgt $\set*{y}=Y \subset X$ und somit ist $J \in R$. 
...
\label{sec:beispiele}
\emph{(Mit Ausrufezeichen)}\todo{Revision 8}
