...
\begin{beweis}
	...
	Homöomorphismus:
	\mapdef{\set*{Y \subset \Omega(A) \text{ abg.} }}{J \lhd A}{Y}{C_0 \enbrace*{\Omega(A) \setminus Y} \cong \set*{f \in C_0(\Omega(A)) \given f|_Y=0} = \bigcap_{y \in Y} \set*{f \in C_0(\Omega(A)) \given f(y)=0}}{}
...
\begin{satz}
	...
	\[
		M_{r_1} \oplus \ldots \oplus M_{r_s} \quad r_1,\ldots,r_s \in \mathbb{N}
	\]
\end{satz}
\begin{beweis}
