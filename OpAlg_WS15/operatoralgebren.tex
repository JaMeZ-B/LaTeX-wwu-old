...
\end{proposition}
\begin{beweis}
	Das einzige, was man sich kurz überlegen muss, ist die Eigenschaft von $(a,b) \mapsto \varphi(a^*b)$ hermitesch zu sein: Dies folge mit (ii) aus folgendem \autoref{satz:53}
	\[
...
\begin{beweis}
	...
	\[
		\begin{array}{rlccl}
			...
			&\hspace{4em}\rotatebox{270}{\ensuremath{\grenzw{\rotatebox{90}{\ensuremath{\lambda}}}}} &&  \rotatebox{270}{\ensuremath{\grenzw{\rotatebox{90}{\ensuremath{\lambda}}}}}& \\
...
\begin{beweis}
	...
	\begin{enumerate}[(i),itemsep=0pt]
		...
		\item Benutze $b^*a^*ab \le b^* \enbrace*{\norm*{a^*a} \cdot \ind_{A^\simm}}b = \norm*{a^*a} \cdot b^*b$. \todo{Revision 5} \qedhere
	\end{enumerate}
\end{beweis}
