...
\begin{beweis}
	...
	\]
	Das rechte Ideal hat eine kleinere Dimension als $A$ und damit sind wir fertig.\todo{Revision 8}
\end{beweis}
...
\begin{beispiel}
	...
	\missingfigure{hier kommt eine etwas esoterische Zeichnung hin \ldots }
...
\begin{beispiel}
	...
	\begin{enumerate}[(i)]
		...
		\begin{enumerate}[a)]
			...
			\end{align}
			\item $A_\theta := C^* \enbrace*{\set*{u,v,1}\mid u,v \text{ unitär},uv=e^{2 \pi i \theta} vu }$ für $\theta \in [0,1]$ bezeichnet man als \Index{Drehungsalgebra}.
			...
			\missingfigure{wieder eine abstrakte Zeichnung}
