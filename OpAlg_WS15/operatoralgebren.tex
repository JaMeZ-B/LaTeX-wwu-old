...
\begin{beispiel}[{name=[für C*-Algebren]}]
	...
	\begin{enumerate}[(i)]
		...
		Tatsächlich ist \emph{jede} abelsche $C^*$-Algebra von dieser Form: 
	\end{enumerate}
\end{beispiel}
...
\begin{beweis}
	...
	\[
		\skal*{\eta}{x \xi} = \lim \skal*{\eta}{x_\lambda \xi} = \lim \skal*{x_\lambda \eta}{x_\lambda \xi} = \skal*{x \eta}{x \xi} = \skal*{\eta}{x^* x \xi}
	\]
