...
\begin{beweis}
	...
	\mapdef{\dot{\pi}\colon\sfrac{A}{\ker \pi}}{B}{a + \ker \pi}{\pi(a)}{}
...
Dann ist $\overline{aAa}$ die kleinste hereditäre $C^*$-Unteralgebra, die $a$ enthält.\marginnote{bei Projektionen kann auf den Abschluss verzichtet werden}
\begin{beweis}
