...
\begin{beweis}
	...
	\]
	Damit ist $e\,a =a$ für alle $a$ und damit auch $e\,a^*= a^*$. Also ist $a\,e =a$ und $e$ somit ein Einselement.
\end{beweis}
...
\begin{proposition}[{name=[von-Neumann-Algebra als unitale von-Neumann-Algebra auffassen]}]
	...
	Dann ist $A$ aufgefasst als Unteralgebra $A_e$ von $\mathcal{B}(e \mathcal{H})$ eine unitale von-Neumann-Algebra ($\ind_{A_e}= \ind_{\mathcal{B}(e \mathcal{H})}$) und es gilt $A_e = (A_e)''$.\todo{Revision 6}
\end{proposition}
\begin{beweis}
