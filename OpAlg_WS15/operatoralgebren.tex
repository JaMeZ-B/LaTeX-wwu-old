...
\begin{beweis}
	...
	\[
		\begin{tikzcd}
			A \dar[hook,"\iota"] \rar["\hat{\hspace{1ex}}"] & \set*{f \in C \enbrace*{\Omega(A) \cup\set*{\chi_\infty}  } \given f(\chi_\infty)=0} \dar[hook] \\
	...
	\]
	Damit ist $a \mapsto \hat{a}$ isometrisch.
\end{beweis}
% section 2 (end)
