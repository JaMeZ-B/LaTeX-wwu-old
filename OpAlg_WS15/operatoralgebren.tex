...
\begin{satz}[{name={GNS-Konstruktion}}]
	...
	$(\mathcal{H}_\varphi,\pi_\varphi,\xi_\varphi)$ ist zyklisch mit $\xi_\varphi = \lim_\lambda e_\lambda+N_\varphi$, wobei $(e_\lambda)_\lambda$ eine approximative Eins von $A$ ist. \emph{Übungsaufgabe 2 von Blatt 8, siehe \cref{sub:gns__zyklisch}}
\end{satz}
