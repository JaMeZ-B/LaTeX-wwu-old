...
\begin{beweis}
	...
	\begin{align}
		...
		&\StackText{C.S.}{\le} \psi^\simm \enbrace*{(\ind-e_\lambda)^2}^{\sfrac{1}{2}} \cdot \psi^\simm \enbrace*{a^*a}^{\sfrac{1}{2}} + \psi^\simm(a^* e_\lambda^2 a)^{\sfrac{1}{2}} \cdot \psi^\simm \enbrace*{(\ind-e_\lambda)^2}^{\sfrac{1}{2}} \\
