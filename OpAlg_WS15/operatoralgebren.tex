...
\begin{beweis}
	...
	\end{align}
	Es folgt $\norm*{x} \le \sqrt{n} \cdot \max_i \norm*{\eta_i}$.\todo{ich bin der Meinung, dass aus jeder Summe ein $n$ stammt, sodass am Ende keine Wurzel mehr auftritt}
...
\begin{beweis}
	...
	\begin{enumerate}[(i)]
		...
		Für Projektionen gilt\todo{Beweis davon könnte man von Thanh oder \citeauthor{Murphy} übernehmen}
		\[
