...
\begin{beweis}
	...
	\begin{align}
		e \xi = \lim_n \enspace\Underbracket{\enbrace*{\sfrac{1}{n} \cdot \ind + xx^*}^{-1} xx^*}{\mathclap{\text{kommutiert da in $C^*(xx^*)$}}}\enspace \xi \in \overline{\im xx^*}= [xx^*] \mathcal{H}
	\end{align}
	Damit ist $[xx^*]e \xi = e \xi$, also $[xx^*]e=e$, woraus insgesamt $[xx^*]=e \in A$ folgt.\todo{Revision 6}
\end{beweis}
