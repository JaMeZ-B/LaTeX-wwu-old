...
\end{document}=======
	$x,y \in \overline{B}(x_n, \varepsilon_n) $ für alle $ >>>>>>> External Changes
=======
		\norm{S T} = \sup_{\norm[X]{x}=1} \norm[X]{S(T(x))} \le \sup_{\norm[X]{x}=1} \enbrace[\big]{\norm{S} \cdot \norm[>>>>>>> External Changes
=======
	$x,y \in \overline{B}(x_n, \varepsilon_n) $ für alle $ >>>>>>> External Changes
=======
Zu $x \in>>>>>>> External Changes
