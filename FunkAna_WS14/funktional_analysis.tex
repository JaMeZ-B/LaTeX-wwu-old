...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=1.2]
		\draw[darkgray] (-2.4,0) -- (2.4,0);
		\draw[darkgray] (0,-2.4) -- (0,2.4);
		\draw[thick] circle[radius=2];
		\draw[thick,DarkGoldenrod2] (2,0) -- (0,2) -- (-2,0) -- (0,-2) -- cycle;
		\draw[thick,Firebrick3] (-2,-2) rectangle (2,2);
	\end{tikzpicture}
	\caption{${\color{DarkGoldenrod2}p=1}$}, $p=2$, ${\color{Firebrick3}p=\infty}$}
\end{figure}
% subsection 62 (end)
