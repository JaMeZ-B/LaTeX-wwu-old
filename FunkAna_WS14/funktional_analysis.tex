...
\minisec{Beweis}
\begin{description}
	\item[Eindeutigkeit:] \todo{Übungen einarbeiten, sobald möglich}
...
\minisec{Beweis}
Übung.\todo{nach Übung hinzufügen}
% subsection 18 (end)
...
$\overline{B}(x_{n+1}, \varepsilon_{n+1}) \subseteq \overline{B}(x_n,\varepsilon_n)$ und $\varepsilon_n \xrightarrow{n \to \infty} 0$. Dann existiert genau ein Punkt in 
