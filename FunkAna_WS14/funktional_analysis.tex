...
\subsection[Definition: Konvexe Teilmenge]{Definition} % (fold)
\label{sub:225}
...
\subsection{Satz} % (fold)
\label{sub:227}
Sei $X$ ein normierter $\mathds{R}$-Vektorraum und $A,B \subset X$ nichtleere konvexe Teilmengen mit \index{Distanz}
\[
