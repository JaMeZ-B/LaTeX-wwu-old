...
$\Lambda := \set[V]{x \in V \subset X \text{ offen}}$. Diese ist gerichtet bezüglich "$\subset$". Zu jedem $V \in \Lambda$ wählen wir\marginnote{Auswahlaxiom nötig!} 
$x_V \in (X \setminus U) \cap V$. Dann gilt $(x_V)_{V \in \Lambda} \subset X \setminus U$ und $x_V \to x$. \bewende \todo{RevChap5}
% subsection 512 (end)
