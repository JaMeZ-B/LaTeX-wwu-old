...
\label{sub:46}
Für $1\le p < \infty$, $f,g \in \mathcal{L}^p(\mu)$ (bzw. $L^p(\mu)$) gilt \index{Minkowski-Ungleichung}
\[
	\norm[p]{f +g} \le \norm[p]{f} + \norm[p]{g}   
\]
\minisec{Beweis}
...
\label{sub:74}
Sei $X$ ein $\mathds{K}$-Vektorraum mit einer positiv semidefiniten hermiteschen Form. Dann gilt für $x,y \in X$ \index{Cauchy-Schwaz-Ungleichung}
\[
