...
\subsection[Satz: Die Einheitskugel eines Banachraumes $X$ liegt $\w^*$-dicht in der Einheitskugel von $X^{**}$]{Satz} % (fold)
\label{sub:516}
...
\begin{enumerate}[(i)]
	...
	\item Es gilt $\sum_{i \in I} \abs*{\skal*{x_i}{x}}^2 = \norm{x}^2$ (\Index{Parcelvalsche Gleichung}) genau dann, wenn $x= \sum_{i \in I} \skal*{x_i}{x} \cdot x_i$.
\end{enumerate}
% subsection 720 (end)
% section 7 (end)
