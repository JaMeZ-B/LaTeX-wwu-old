...
\begin{enumerate}[(a)]
	...
	hat $(x_n)_n$ einen Häufungspunkt. Benutze nun 1. abzählbar.\todo{genauer ausführen}
...
\subsection[Satz: Konvergenz eines monoton wachsenden, beschränkten Netzes selbstadjungierter Operatoren]{Satz} % (fold)
\label{sub:732}
