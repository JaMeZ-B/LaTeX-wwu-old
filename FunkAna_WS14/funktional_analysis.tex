...
\begin{enumerate}[(i)]
	...
	\item \[
		...
		\end{tikzpicture}
	\]
	Benutze: $0 = \varphi(0) = \varphi(x-x) \le \varphi(x) + \varphi(-x)$. \todo{Rev Chap 2}
\end{enumerate}
% subsection 218 (end)
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption[Einheitskugeln für $p=2$, ${\color{DarkGoldenrod2}p=1}$ und ${\color{Firebrick3}p=\infty}$]{Einheitskugeln für $p=2$, ${\color{DarkGoldenrod2}p=1}$ und 
