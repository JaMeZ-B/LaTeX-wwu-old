...
\begin{itemize}
	\item $x \in U$ heißt \Index{regulärer Punkt}, von f, falls $Df(x) \in \Mat_{k,m}(\mathbb{R})$ den Rang $k$ hat (d.h $Df(x)$ stellt eine surjektive lineare Abbildung von $\mathbb{R}^n \to \mathbb{R}^k$ dar.)
