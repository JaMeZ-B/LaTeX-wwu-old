...
\begin{align*}
	...
	&\text{Für } n \neq m \text{ gilt } d(x_n,x_m) \geq \varepsilon \\
	&\text{Dann ist } n>m \text{ ,so ist nach Konstruktion } x_n \notin B_{\varepsilon}(x_m)
 \end{align*}
 Keine Teilfolge von $(x_r)_r$ kann eine Cauchyfolge sein
 \[
...
\[
	x+U = \{ x+y \,|\,y \in U\} \subseteq \mathbb{R}^n
\]
...
\underline{Umformulierung}:(aus AnaI) \\
