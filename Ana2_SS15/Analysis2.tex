...
\begin{enumerate}
	...
	\item Falls $f$ einen positiven Eigenwert hat, so hat $f$ bei $x$ kein lokales Minimum
	\item Falls $f$ einen negativen Eigenwert hat, so hat $f$ bei $x$ kein lokales Maximum
