...
\begin{enumerate}[a)]
	...
	\]
	wo $\chi_{Q_j} : \mathds{R}^n \to \mathds{R}$ die charakteristische Funktion von $Q_j$ ist, \marginnote{auch mit $\mathds{1}_{Q_j}$ bezeichnet}
	\[
...
\label{sub:93}
\begin{enumerate}[(i)]
	\item $\sigma$-Algebren sind abgeschlossen bezüglich abzählbarer Vereinigungen und Durchschnitten. \marginnote{de Morgan}
