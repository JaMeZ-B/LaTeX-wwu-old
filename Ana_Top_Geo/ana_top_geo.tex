...
\begin{enumerate}[(i)]
	...
	\[
		\vcenter{\hbox{\tikz{\draw[dashed, fill=LightBlue2] (0,0) circle[radius=0.5];}}} \enspace\subseteq \enspace
		\vcenter{\hbox{\tikz{\draw[fill=LightBlue2!70] (0,0) circle[radius=0.5];}}}
	\]
