...
\subsection[Bemerkung: Jede stetige Abbildungen zwischen $C^\infty$-Mannigfaltigkeiten lässt sich approximieren]{Bemerkung} % (fold)
\label{sub:174}
...
% subsection 174 (end)
\minisec{Ziel}
$\pi_n(S^m, e_0) = 0$ für $n <m$ \todo[noline]{RevChap17}
