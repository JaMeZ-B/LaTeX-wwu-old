...
\begin{enumerate}[(1)]
	...
	\item Sei $K \subseteq \mathds{R}^n$ ein konvexe Teilmenge und $x_0 \in K$. Dann ist $(K,x_0)$ zusammenziehbar:
	\begin{align*}
...
\[
	(f_n)_* ([\omega]) = n \cdot [\omega] \in \pi_1\enbrace{S^1,1} = \mathds{Z}
\]
...
\minisec{Beweis}
Angenommen $p$ hat keine Nullstelle. In den Übungen haben wir gezeigt, dass dann $f_n : S^1 \to S^1$ homotop zu einer konstanten Abbildung ist. Aus der Proposition folgt 
dann aber $n=0$. \bewende
% subsection 1121 (end)
% section 11 (end)
