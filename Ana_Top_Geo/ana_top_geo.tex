...
\]
Diese sind $C^\infty$-Funktionen (Analysis II.)
\begin{figure}[H]
	\centering{
...
\end{figure}%
\todo[noline]{$\mathds{R}^2$-Variante von $f_{\varepsilon,r}$ plotten}%
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[baseline]
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Glockenfunktion $f_{\varepsilon,r}$ für $\varepsilon=1$, $r=1.5$ sowie für $\mathds{R}$, also auch $\mathds{R}^2$}}
\end{figure}
