...
\begin{description}
	...
	\item[Exaktheit bei $\pi_n(E,e_0)$:] Sei $[\omega ] \in \pi_n(F, e_0)$. Dann ist $p \circ i \omega \equiv b_0$, also $\im \pi_n (i) \subseteq \ker \pi_n(p)$.
	...
	$F$ ist. Also gilt $\ker \pi \partial_n \subseteq \im \pi_n(p)$.
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=1.2]
		...
		\coordinate (x) at (2,2);
		\path (5,1) coordinate (ecke)  +(1,0) node[below]{$V \subseteq \mathds{R}^2$} +(0,1) coordinate(start); % 
