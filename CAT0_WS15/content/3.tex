...
\begin{satz}
\label{satz:3.7}
	Bäume sind $\CAT$-Räume. \todo{Referenz auf Übungsaufgabe}
\end{satz}
...
Eine simpliziale Isometrie $f \colon X \rightarrow X$ hat eine Inversion, wenn folgendes passiert: \todo{Zeichnung einfügen}
...
\begin{no-satz}[\textsc{Helly}s Theorem für Bäume]
	...
	Wenn sich jeweils zwei Elemente aus $\mathcal{S}$ nichttrivial schneiden, dann ist $\cap \mathcal{S}$ nicht leer. \todo{Referenz auf ÜA}
\end{no-satz}
