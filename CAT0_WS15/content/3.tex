...
\begin{definition}[medianer Graph]
	\label{def:3.22}
		...
		Das Intervall $I(u,v)$ für $u,v \in V$ ist definiert durch \todo{Bild einfügen}
		\[
...
\begin{beweis}
	...
	\begin{enumerate}[(i)]
		...
		Wähle $H$ mit minimalem Abstand zu $m$. \todo{Bild einfügen}
		...
		Es ist $w \in I(x,y)$:
		Ansonsten existiert nach Hilfslemma eine Hyperebene $J$, die $w$ und $\{x,y\}$ trennt. \todo{Bild einfügen}
