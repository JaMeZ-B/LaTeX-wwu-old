...
\label{bew:tech_lemma}
	...
	\begin{enumerate}[(1)]
		...
		\begin{figure}[h]
			...
			\draw [very thick,color=red] (pbar) -- (2.65,-2) node[fill,circle,inner sep=1.5,color=Green4]{};
			\draw [color=red] (1.365,-2) node[above]{$\mathbf{\alpha}$};
			
			\draw [very thick,color=Green4] (4.2,-1.99) -- (1.55,-1.99) node[fill,circle,inner sep=1.5,color=red]{};
