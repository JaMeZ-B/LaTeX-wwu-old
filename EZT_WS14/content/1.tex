...
\begin{falko}[Satz von Euklid] \label{F1.5}
	Jede Primzahl $p$ ist ein Primelement von $\ZZ$, d.h. es gilt stets \eqref{eq_def_1.6}. \marginnote{17.10.} (Das gleiche gilt für $-p$, also für jedes unzerlegbare Element von $\ZZ$.) \index{Satz von Euklid}
\end{falko}
...
\begin{falko} \label{F1.8}
	Sei $R$ faktoriell, $P$ wie oben. Es gelten: \marginnote{21.10.}
	\begin{enumerate}[(i)]
