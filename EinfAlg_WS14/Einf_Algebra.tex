...
\begin{center}
	\begin{tikzcd}[column sep=small]
		K[T] \ar{rr}{\Phi_u} \ar{rd}[below,left]{} & & L\\
		& \Quot(K[T])=K(T) \ar{ru}[below,right]{\tilde{\Phi_u}} &\\
...
(iii): $z\in\mc{K}(S)\Rightarrow \re(z),~\im(z),\overline{z}\in\mc{K}(S)$ also $i\cdot \im(z)=z-\re(z)\in\mc{K}(S)$.\\
...
(ix): $r\in\mc{K}(S)\cap\R,~r>0\Rightarrow\sqrt{r}\in\mc{K}(S)$
\begin{equation*}
\begin{aligned}
	1^2+s^2&=\beta^2\\
	r^2+s^2&=\alpha^2\\
...
(x): $z\in\mc{K}(S),~w\in\C,~w^2=z\Rightarrow w\in\mc{K}(S)$.
\[
...
\subsection{Satz 22}
\label{sub:satz_22}
Sei $S=\penbrace{0,1,p_1\dt{,}p_m}\subseteq \C$, sei $K=\Q(p_1,\overline{p_1}\dt{,}p_m,\overline{p_m})\subseteq \mc{K}(S)\subseteq \C$.
Sei $q\in \mc{K}(S)$.
