...
(v): $z,w\in\mc{K}(S),~z,w\neq v \Rightarrow \hat{z}\cdot \hat{w}\in \mc{K}(S)$. $\hat{z},\hat{w}$ sind Drehungen um den Ursprung um Winkel $\alpha,\beta\rightsquigarrow \hat{z}\cdot\hat{w}$ Drehung um Winkel $\alpha+\beta$.
