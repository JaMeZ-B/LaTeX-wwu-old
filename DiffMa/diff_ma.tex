\input{\string~/Dropbox/Studium/verschiedenes/LaTeX-Vorlage/mitschrift_v2.tex}
...
\input{\string~/Dropbox/Studium/verschiedenes/LaTeX-Vorlage-xetex/mitschrift_headings.tex}
\automark{subsection}
...
\begin{figure}[h]
	...
	\end{tikzpicture}
	\caption{Zeichnung zu Beispiel \ref{ssub:246} (unvollständig)}}
\end{figure}
