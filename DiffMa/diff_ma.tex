...
ist, ist der Fluss von $Y$ global. \bewende \marginnote{Hier fehlt noch ein ganzes Stück, wurde anscheinend in der Vorlesung übersprungen oder vergessen!}
...
\begin{itemize}
	\item $E,B$ sind Hausdorff-Räume. \marginnote{$B$ als Mannigfaltigkeit, $E$ als Menge der Tangentialräume vorstellen}
	\item $\pi : E \to B$ ist stetige Surjektion, sodass jede \Index{Faser} $E_b := \pi ^{-1}(b)$ die Struktur eines $n$-dimensionalen Vektorraumes hat, und sodass
...
\[
	\begin{tikzpicture}[scale=1.5]
	    ...
	    \shade[ball color=blue!10!white,opacity=0.20] (0,0) circle (1cm);
	\end{tikzpicture}
\]\marginnote{Zeichnung vervollständigen!}
