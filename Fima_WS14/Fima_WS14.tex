...
Seien $(\Omega,\mathcal{F}),(E,\mathcal{E})$ messbare Räume. Ein \Index{stochastischer Kern} ist eine Abbildung $K:\E\times \F \to [0,1]$ mit folgenden Eigenschaften:
\begin{enumerate}[(i)]
...
\begin{enumerate}
	...
	\begin{enumerate}[(1)]
		...
		\[
		\E(S_{\tau_{\land n}}-(\tau_{\land n})(2p-1))=0 \Leftrightarrow \E(\tau_{\land n})(2p-1)=\E S_{\tau_{\land n}} 
		\]
		$\E \tau_{\land n} \uparrow \E\tau$ monotone Konvergenz\\
		$\E S_{\tau_{\land n}}\stackrel{\tiny n\to\infty}{\to} \E S_\tau$ majorisierte Konvergenz, da $\abs{S_{\tau_{\land n}}}\le \max\{\abs{a},b \}$\\
		...
		\[
		\E(S_{\tau_{\land n}}^2-(\tau_{\land n})\E X_1^2=0 \Leftrightarrow \E S_{\tau_{\land n}}^2= \underbracket{X_1^2}_{=1}\cdot \E(\tau_{\land n})
		\]
...
\begin{itemize}
	...
	\item Informationsverlauf wir gegeben durch eine Filtration $(\F_n)_{n=0,\dots,N}$
	...
	$S(n)$ ist der zufällige Vektor der Preis nach $n$ Perioden für die risky assets.
	...
	\end{aligned}
	\end{equation*}
	wobei $(S(n))_{n=1,\dots,N}$ ein vorhersehbarer Prozess ist mit 
	\[
...
Wird beim Handel in den Handelszeitpunkten $^,\dots,N-1$ kein Kapital hinzugefügt bzw. entnommen, so nennt man diese Handelsstrategie \Index{selbstfinanzierend}.\\
...
\begin{enumerate}[(a)]
	...
	\]
	\item short selling and hold einer Aktie:\\
