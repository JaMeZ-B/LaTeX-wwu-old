...
\[
\frac{\dint \bar{\Pw}}{\dint \Pw}|_{\F_t}=L_t~\forall t\ge 0
\]
Dann gilt:
\begin{enumerate}[(i)]
	...
	\[
	\frac{\dint Q_T}{\dint \Pw}|_{\F_t}=R_t~\forall t\le T
	\]
\end{enumerate}
...
\begin{aligned}
	...
	&= \int\ablim{A}\E(YL_t~|~\F_s)\frac{1}{L_s}\dint\bar{\Pw}, \text{ da } \frac{\dint \bar{\Pw}}{\dint \Pw}|_{\F_s}=L_s
\end{aligned}
\end{equation*}
...
&= \E\enbrace{g(W_t-W_s-\nu(t-s))\frac{L_t}{L_s}~|~\F_s} = \E\enbrace{g(W_t-W_s-\nu(t-s))\exp\enbrace{\nu(W_t-W_s)-\frac{1}{2}\nu^2(t-s)}~|~\F_s}\\
&= \E g(W_t-W_s-\nu(t-s))\exp\enbrace{\nu(W_t-W_s)-\frac{1}{2}\nu^2(t-s)} = \E g(W_{t-s}-\nu(t-s))\exp\enbrace{\nu W_{t-s}-\frac{1}{2}\nu^2(t-s)}\\
&= \E_\nu g(\bar{W}_{t-s})
\end{aligned}
\end{equation*}
