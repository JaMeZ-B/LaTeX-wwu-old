...
\begin{itemize}
	...
	\[
	F(t_{i-1},t_{i-1},t_i)=\frac{1}{t_i-t_{i-1}}\cdot \enbrace{\frac{1}{B(t_{i-1},t_i)}-1} 
	\]
	also
	\begin{equation*}
	\begin{aligned}
...
\begin{enumerate}[(a)]
	...
	\begin{itemize}
		...
		\item Barwert der Ausgaben: $\mathds{E}V_0(A)=\sum_{k=0}^{n-1}R\cdot v^{m+k}\mathds{P}(T>m+k)$
...
\begin{enumerate}[(i)]
	...
	Dies ist die \Index{Black-Scholes Differentialgleichung}.
	Da gilt:
	\[
...
\uline{Antwort:}
Nein, da der beobachtete \Index{Smile-Effekt} im Black-Scholes Modell nicht vorkommt.\\
