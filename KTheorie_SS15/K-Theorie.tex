...
\leavevmode
\begin{enumerate}[a)]
	\item $q \colon f^* E \to Y$ ist ein Vektorbündel und $(\overline{f},f)$ ist ein Morphismus von Vektorbündeln. \todo{Revision}
...
\]
der verträglich ist mit Pullbacks und $F_\pt=F$ erfüllt. \todo{Rev 2}	
\end{lemma}
\begin{beweis}
Sei $m=r+s$. Definiere 
\(
...
\todo[inline]{kommt der Beweis noch?}	
\end{satz}
