...
\begin{itemize}
	...
	\[
		\begin{tikzcd}[sep=6em]
			0 \rar & C_n \rar["\tau"] & \tau(C_n) \oplus \mathds{Q} \rar["(c_{n-1} \oplus \id)|_Q \circ \pr_Q"] & C_{n-2} \oplus C_n \rar & \cdots
		\end{tikzcd}
	\]
	stimmt über $A$ mit dem obigen überein, liefert also dieselbe Klasse. Aber
	\[
		\benbrace*{0\to C_n \xrightarrow{\tau} \tau(C_n) \to 0  \to \cdots } =0 \bewende 
	\]
\end{itemize}
