...
\label{sub:23}
Seien $X$ und $Y$ topologische Räume. Sei $f \colon Y \to X$ eine stetige Abbildung und sei\marginnote{Der Pullback lässt sich auch allgemein auf kategorieller Ebene 
definieren} $p \colon E \to X$ ein Vektorbündel. Dann heißt
\[
...
$\psi_i^{-1}(V_i)$ mit $V_i \subset U_i \times F \enbrace*{K^{\ell_1}, \ldots , K^{\ell_m}}$ offen ist und $\psi_j \circ \psi_i ^{-1}(V)$ offen ist.
