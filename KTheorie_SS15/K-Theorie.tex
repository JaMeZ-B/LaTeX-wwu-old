...
$\mathds{C} \cup \set{\infty} 7to \mathds{C}P^1 $, definiert duch $z \mapsto \benbrace*{z:1}, \infty \mapsto \benbrace*{1:0}$. Die Umkehrabbildung ist gegeben durch
\[
...
mit $z$. Es ist nun $H= \set{\mathds{C}, w \mapsto w \cdot z} = \set{\mathds{C},z} $.
...
$\mu \colon K^1(X) \otimes \nicefrac{\mathds{Z}[H]}{(H-1)^2} \to K^0(X) \otimes  K^0(S^2) \to K^0(X \times S^2)$ ist ein Ringisomorphismus . Insbesondere $K^0(S^2) \cong \nicefrac{\mathds{Z}[H]}{(H-1)^2}$
% section 3 (end)
