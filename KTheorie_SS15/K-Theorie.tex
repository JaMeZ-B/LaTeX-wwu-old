...
\begin{satz}[{name={Fortsetzungssatz von Tietze}}]
...
\begin{enumerate}[a)]
	...
	sodass $\hat{f}|_U \colon E|_U \to E'|_U$ ein Isomorphismus von Vektorbündeln ist. \todo{Revision}
\end{enumerate}	
\end{lemma}
...
\begin{lemma}[{name=[{Trivialisierbarkeit von $E \to X \times [a,b]$, wenn $E|_{X \times [a,c]}$, $E|_{X \times [c,b]}$ trivialisierbar}]},label=trivialisierbarkeit_verkleben]
...
von Vektorbündeln $X \times [a,b] \times K^n \to E$ zusammensetzen.	
\end{beweis}
