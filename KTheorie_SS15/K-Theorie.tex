...
\begin{itemize}
	...
	\[
		...
		\end{tikzcd}
	\]
	\circled{5} kommutiert nach Definition von $\delta^{-(n+1)}$. Die linke Spalte des Diagramms ist exakt, also auch die rechte Spalte. \qedhere
\end{itemize}
\end{beweis}
\newpage
...
$\begin{tikzcd}[cramped,sep=small]0 \rar & E_1 \rar["\tilde{f}_1"] & E_0 \rar & 0\end{tikzcd}$. \todo{Revision}
