...
\end{align*}
Dann gilt $\psi_V \circ \kappa_V=\id_{V \times K^n}$ und $\kappa_V \circ \psi_V = \id_{q^{-1}(V)}$. Außerdem kommutiert das Diagramm aus \ref{def_vektbuendel}. Also ist 
...
\begin{lemma}[{name=[Induzierter Funktor eines stetigen Funktors]}]
...
\todo[inline]{Wenn alles mit \texttt{thmtools} umgebaut ist, kann hier restate benutzt werden}
\minisec{Satz}
