...
\]
Das Inverse hierzu bildet $(x,w') \in X \times K^{nN}$ auf $\enbrace*{\psi ^{-1} \enbrace*{ (1- p(x)) w'}, p(x)w'}$ ab. \todo{Revision}
\end{beweis}
