...
\begin{enumerate}[a)]
	...
	$h_t(a)=h_0(a)$ für alle $a \in A$, dann lässt sich der Isomorphismus aus a) so wählen, dass er den durch $h$ induzierten Isomorphismus 
...
mit $\varphi|_{X \times \set{1}} =\id$. \bewende 
% subsection 210 (end)
% section 2 (end)
