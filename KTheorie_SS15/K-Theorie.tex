...
Sei $(X,A)$ ein Ko-Raumpaar. Seien $p \colon E \to X$ und $p' \colon E' \to X$ $K$-Vektorbündel und $f \colon E'|_A \to E|_A$ ein Isomorphismus, $(E,f,E')$ also ein Tripel. 
Sei weiter $f' \colon E' \to E$ ein Isomorphismus von $K$-Vektorbündeln und $h \colon A \times I \to \Iso(E'|_A,E|_A)$ eine stetige Abbildung, so dass $h_t$ ein Schnitt ist 
für alle $t \in I$ und so dass $h_0=f'|_A$, $h_1=f$ gilt. 

Dann existiert ein Isomorphismus $F \colon E' \to E$ mit $F|_A=f$ und eine Homotopie $H \colon X \times I \to \Iso(E',E)$ mit $H_0=f'$, $H_1=F$ und $H|_{A\times I}=h$.	
\end{lemma}
\begin{beweis}
