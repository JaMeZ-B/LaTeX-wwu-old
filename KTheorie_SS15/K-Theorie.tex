...
\begin{enumerate}[(i)]
	...
	$g ^{-1} \circ f$ homotop zu $\id_{E_0}$ durch Isomorphismen. Also folgt aus Lemma \ref{sub:33}, dass sich $g ^{-1} \circ f$ zu einem Isomorphismus über $X$ fortsetzen 
	...
	\begin{align*}
		...
		&= \Underbrace{\benbrace*{E_0 \oplus E_1, f \oplus g ^{-1}, E_1 \oplus E_0}_\st }{=\benbrace{0,\id,0}} + \benbrace*{E_0,g,E_1}_\st \qedhere
	\end{align*}
\end{enumerate}
\end{beweis}
% subsection 34 (end)
