...
\begin{enumerate}[(1)]
	...
	\item Maximierung der Varianz: $\phi_1$ ist die Richtung höchster Varianz von $\{u_i^N\}_{i=1}^n$, $\phi_2$ ist die Richtung höchster Varianz von $\{ P_{X_1} u_i^N\}_{i=1}^n$, usw.
